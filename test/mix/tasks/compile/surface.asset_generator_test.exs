  ...
  test "generate css file and add header comment", %{opts: opts} do
    ...
    assert File.read!(@css_output_file) == """
           ...
           */
           ...
           /* Mix.Tasks.Compile.SurfaceTest.FakeButton (2a98af4) */

           .btn[data-s-2a98af4] { padding: 10px; color: var(--c57608f--color); }

           /* Mix.Tasks.Compile.SurfaceTest.FakeLink (b8566f5) */

             .link[data-s-b8566f5] { padding: 10px; }

           /* Mix.Tasks.Compile.SurfaceTest.FakePanel (210f1ef) */

             .panel[data-s-210f1ef] { padding: 10px; }
           """
  end
