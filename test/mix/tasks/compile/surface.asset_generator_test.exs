defmodule Mix.Tasks.Compile.Surface.AssetGeneratorTest do
  ...
  @tailwind_variants_rel_output_file Path.join(@css_output_dir, "_tailwind.variants.js")
  @tailwind_variants_output_file Path.join(File.cwd!(), @tailwind_variants_rel_output_file)
  ...
  setup do
    ...
    on_exit(fn ->
      ...
      File.rm_rf!(@tailwind_variants_output_file)
    end)
    ...
    %{
      opts: [
        ...
        tailwind_variants_output_file: @tailwind_variants_rel_output_file
      ]
    }
  end
  ...
  test "generate variant file and add header comment", %{opts: opts} do
    refute File.exists?(@tailwind_variants_output_file)

    assert run(@components ++ [FakeButtonWithVariant], opts) == []

    s_attr = scope_attr(FakeButtonWithVariant)

    assert File.read!(@tailwind_variants_output_file) == """
           /*
           This file was generated by the Surface compiler.
           */
