defmodule Mix.Tasks.Compile.Surface.AssetGeneratorTest do
  ...
  @css_output_file Path.join(File.cwd!(), @hooks_rel_output_dir)
  # @button_src_css_file Path.join(@test_components_dir, "fake_button.css")
  # @button_src_css_file_content """
  # .btn { padding: 10px; }
  # """
  # @link_src_css_file Path.join(@test_components_dir, "fake_link.css")
  # @link_src_css_file_content """
  # .link { padding: 10px; }
  # """
  ...
  setup do
    ...
    # File.write!(@button_src_css_file, @button_src_css_file_content)
    # File.write!(@link_src_css_file, @link_src_css_file_content)
    ...
    on_exit(fn ->
      ...
      File.rm_rf!(@css_output_file)
      # File.rm_rf!(@button_src_css_file)
      # File.rm_rf!(@link_src_css_file)
    end)

    %{opts: [hooks_output_dir: @hooks_rel_output_dir, css_output_file: @css_rel_output_file]}
  end

  # test "copy css files to output dir and add header comment", %{opts: opts} do
