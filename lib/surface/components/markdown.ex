defmodule Surface.Components.Markdown do
  ...
  It uses [Earmark](https://github.com/pragdave/earmark) for markdown
  parsing/translation to HTML.
  ...
  You can have a default class applied globally by adding the following configuration
  to your `config.exs`:

  ```
  config :surface, :components, [
    {Surface.Components.Markdown, default_css_class: "content"}
  ]
  ```
  ...
  def translate({_, attributes, children, %{line: tag_line}}, caller) do
    ...
    class = props[:class] || MacroComponent.get_config(__MODULE__, :default_css_class)
